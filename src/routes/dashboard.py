...
def index():
    ...
    # Saldo total das contas (saldo inicial + movimentos pagos)
    ...
    # Necessidade e disponibilidade do dia (previsto)
    ...
    # Lançamentos por tipo (últimos 7 dias)
    ...
    # Grafico fluxo de caixa (previsto x realizado) - periodo configurado
    ...
    # Valor previsto a receber e a pagar para o período do perfil
